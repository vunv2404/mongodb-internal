...
## AVL-Tree Problems
 ...
 - Multi-versioning control not supported.
    ...
    - You would probably want to take the express line from stop 14 and get down on stop 42. Then take the local train from stop 42 and reach the destination 59 from there, as shown below.
